...
-- name: SetPresencesIsPaidStatusByIds :exec
UPDATE presence SET is_paid = ?
WHERE id IN (sqlc.slice('ids'));

-- name: GetPresencesForTeacherSalary :many
...
WHERE
    ...
    AND (presence.teacher_id = sqlc.arg('teacher_id') OR sqlc.arg('use_teacher_filter') = false)
