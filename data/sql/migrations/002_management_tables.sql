...
(
  ...
  CONSTRAINT fk_teacher_id FOREIGN KEY (teacher_id) REFERENCES teacher(id) ON UPDATE CASCADE ON DELETE SET NULL,
  -- a `class` must migrate to another `course` first before the `course` getting deleted
  CONSTRAINT fk_course_id FOREIGN KEY (course_id) REFERENCES course(id) ON UPDATE CASCADE ON DELETE RESTRICT
);
...
(
  ...
  CONSTRAINT fk_class_id FOREIGN KEY (class_id) REFERENCES class(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
(
  ...
  CONSTRAINT fk_enrollment_id FOREIGN KEY (enrollment_id) REFERENCES student_enrollment(id) ON UPDATE CASCADE ON DELETE SET NULL
);
...
(
  ...
  CONSTRAINT fk_teacher_id FOREIGN KEY (teacher_id) REFERENCES teacher(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
(
  ...
  CONSTRAINT fk_class_id FOREIGN KEY (class_id) REFERENCES class(id) ON UPDATE CASCADE ON DELETE SET NULL,
  CONSTRAINT fk_teacher_id FOREIGN KEY (teacher_id) REFERENCES teacher(id) ON UPDATE CASCADE ON DELETE SET NULL,
  ...
  CONSTRAINT fk_token_id FOREIGN KEY (token_id) REFERENCES student_learning_token(id) ON UPDATE CASCADE ON DELETE RESTRICT
);

CREATE TABLE student_attend
(
  student_id BIGINT unsigned NOT NULL PRIMARY KEY,
  presence_id BIGINT unsigned NOT NULL PRIMARY KEY,
  -- `student_attend` is an entity for many-to-many relationship
  CONSTRAINT fk_student_id FOREIGN KEY (student_id) REFERENCES student(id) ON UPDATE CASCADE ON DELETE CASCADE,
  CONSTRAINT fk_presence_id FOREIGN KEY (presence_id) REFERENCES presence(id) ON UPDATE CASCADE ON DELETE CASCADE
);
...
(
  ...
  CONSTRAINT fk_instrument_id FOREIGN KEY (instrument_id) REFERENCES instrument(id) ON UPDATE CASCADE ON DELETE RESTRICT,
  CONSTRAINT fk_grade_id FOREIGN KEY (grade_id) REFERENCES grade(id) ON UPDATE CASCADE ON DELETE RESTRICT
);
